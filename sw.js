...
const CACHE_NAME = 'reparole-v6-250';
...
const APP_SHELL = [
  ...
  './fonts/fredoka-latin-ext-400-normal.woff2',
...
self.addEventListener('fetch', (event) => {
  ...
  // v6.248 : les photos d'exercice (img/) suivent la même règle que les
  // voix — nommées d'après un contenu qui ne change jamais (codepoints de
  // l'emoji), donc rien à invalider entre les versions.
