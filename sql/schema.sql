...
begin
  ...
  return jsonb_build_object(
    ...
    -- v6.133 : niveau par type d'exercice (point 15 de la demande
    -- d'amélioration) — v_patient.levels vaut '{}'::jsonb tant que la
    -- migration v6.132 n'a pas encore été appliquée, ce qui est géré
    -- normalement côté client (voir js/caregiver.js).
    'levels', v_patient.levels,
