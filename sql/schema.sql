...
-- v6.30 : p_plan ajouté (voir sql/migrations/002_plan_upsert.sql pour le
-- détail du bug corrigé — installation existante ? exécuter cette
-- migration plutôt que de recréer ce fichier en entier).
