# Kabyle — glossaire de cohérence (relecture native, v6.113-v6.122)

**🎉 Interface complète : 448/448 clés (v6.120), affinée en v6.121-122.**
Fourni par le même contact kabylophone que `Kabyle_Complet.xlsx`, en
plusieurs envois. À consulter avant toute future modification, pour
rester cohérent.

## 🔒 Glossaire figé (recommandation du contact, v6.122)

Termes validés à ne plus changer, pour garantir une cohérence parfaite
dans toute l'app :

Asemdan (exercice) · Tiɣimit (séance) · Aswir (niveau) · Asfari
(progression) · Aḍfar (suivi) · Agmar (cheval) · Takeṛṛust (voiture) ·
Tawwurt (porte) · Avilu (vélo) · Tamuturt (moto) · Aɣyul (âne)
...
## 🔒 Termes figés — ne plus modifier (v6.121)

Sur recommandation explicite du contact kabylophone, ces termes sont
**validés définitivement** pour toute la suite du projet — ne pas les
retraduire différemment même si une autre proposition semble
plausible plus tard :
