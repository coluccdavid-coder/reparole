...
> **Version documentée : `reparole-v6-250`** — cette ligne est vérifiée
...
- `docs/IMAGES.md` — remplacer les emoji d'exercice par de vraies photos :
  fonctionnement, règles du dossier `img/`, et la liste des 116 fichiers
  attendus (générée par `scripts/liste-images.js`).
- `docs/RGPD.md` — registre des traitements (document de travail),
  durées de conservation réelles, procédures d'export/suppression, lacunes
  connues avant mise en production.
- `docs/AUDIT-v6.245.md` — audit complet de juillet 2026 : ce qui est sain
  (traductions, RLS, `search_path`), ce qui ne l'est pas (poids de l'app
  patient, pages non traduites), et ce qui a été corrigé.
