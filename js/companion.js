...
const COMPANION_PHRASES = {
  fr: {
    ...
    explain: {
      ...
      association: "Cet exercice vous aide à retrouver ce qui va ensemble, sans avoir besoin de parler.",
      syntax: "Cet exercice travaille la construction des phrases : reconnaître celle qui est bien formée.",
      rhyme: "Cet exercice travaille la sonorité des mots : reconnaître ceux qui riment ensemble.",
      story: "Cet exercice propose un petit texte à lire, puis une question pour vérifier ce que vous avez compris.",
      heure: "Cet exercice entraîne à reconnaître l'heure — une compétence utile au quotidien, souvent affectée après une lésion cérébrale.",
      monnaie: "Cet exercice travaille les nombres de la vie de tous les jours : compter des pièces, des billets, ou du rendu de monnaie.",
      calcul_quotidien: "Cet exercice propose de petits calculs pratiques, comme ceux qu'on rencontre dans une vraie journée.",
      comparaison_nombres: "Cet exercice entraîne à comparer des nombres — plus grand, plus petit — à votre rythme.",
      prix: "Cet exercice travaille le sens pratique des prix, pour retrouver des repères du quotidien.",
      croises: "Cet exercice est une grille de mots croisés : chaque mot à trouver est montré par une image.",
      memoire_liste: "Cet exercice entraîne la mémoire de travail : on regarde des images, puis on les retrouve un peu plus loin.",
      anagramme: "Ce jeu remet un mot dans l'ordre : les lettres (ou syllabes) sont mélangées, à vous de les replacer.",
      verif: "Ce jeu demande si deux images vont ensemble : on répond oui ou non, à votre rythme."
    }
  },
  en: {
    welcome: [
    ...
    explain: {
      ...
      croises: "This exercise is a crossword grid: each word to find is shown by a picture.",
      memoire_liste: "This exercise trains working memory: you look at pictures, then find them again a little later.",
      anagramme: "This game puts a word back in order: the letters (or syllables) are shuffled, you place them back.",
      verif: "This game asks whether two pictures go together: answer yes or no, at your own pace."
    }
  },
  es: {
    welcome: [
    ...
    explain: {
      ...
      croises: "Este ejercicio es un crucigrama: cada palabra por encontrar se muestra con una imagen.",
      memoire_liste: "Este ejercicio entrena la memoria de trabajo: se miran imágenes y luego se vuelven a encontrar un poco después.",
      anagramme: "Este juego ordena una palabra: las letras (o sílabas) están mezcladas, usted las recoloca.",
      verif: "Este juego pregunta si dos imágenes van juntas: se responde sí o no, a su ritmo."
    }
  },
  it: {
    welcome: [
    ...
    explain: {
      ...
      croises: "Questo esercizio è un cruciverba: ogni parola da trovare è mostrata da un'immagine.",
      memoire_liste: "Questo esercizio allena la memoria di lavoro: si guardano delle immagini, poi le si ritrova poco dopo.",
      anagramme: "Questo gioco rimette in ordine una parola: le lettere (o sillabe) sono mischiate, tocca a lei ricollocarle.",
      verif: "Questo gioco chiede se due immagini vanno insieme: si risponde sì o no, al suo ritmo."
    }
  },
  pt: {
    welcome: [
    ...
    explain: {
      ...
      croises: "Este exercício é palavras cruzadas: cada palavra a encontrar é mostrada por uma imagem.",
      memoire_liste: "Este exercício treina a memória de trabalho: olham-se imagens e depois voltam a encontrar-se um pouco mais adiante.",
      anagramme: "Este jogo reordena uma palavra: as letras (ou sílabas) estão baralhadas, cabe-lhe recolocá-las.",
      verif: "Este jogo pergunta se duas imagens combinam: responde-se sim ou não, ao seu ritmo."
    }
  },
  de: {
    welcome: [
    ...
    explain: {
      ...
      croises: "Diese Übung ist ein Kreuzworträtsel: jedes gesuchte Wort wird durch ein Bild gezeigt.",
      memoire_liste: "Diese Übung trainiert das Arbeitsgedächtnis: man betrachtet Bilder und findet sie kurz darauf wieder.",
      anagramme: "Dieses Spiel bringt ein Wort in Ordnung: die Buchstaben (oder Silben) sind gemischt, Sie setzen sie zurück.",
      verif: "Dieses Spiel fragt, ob zwei Bilder zusammenpassen: Sie antworten ja oder nein, in Ihrem Tempo."
    }
  },
  ar: {
    welcome: [
    ...
    explain: {
      ...
      croises: "هذا التمرين شبكة كلمات متقاطعة: كل كلمة تبحث عنها معروضة بصورة.",
      memoire_liste: "هذا التمرين يدرّب ذاكرة العمل: تنظر إلى صور، ثم تعثر عليها بعد قليل.",
      anagramme: "هذه اللعبة تعيد ترتيب كلمة: الحروف (أو المقاطع) مخلوطة، وعليك إعادة ترتيبها.",
      verif: "هذه اللعبة تسأل إن كانت صورتان تتناسبان: تجيب بنعم أو لا، على إيقاعك."
    }
  },
  tr: {
    welcome: [
    ...
    explain: {
      ...
      croises: "Bu alıştırma bir bulmaca ızgarasıdır: bulunacak her kelime bir resimle gösterilir.",
      memoire_liste: "Bu alıştırma çalışma belleğini çalıştırır: resimlere bakarsınız, sonra biraz sonra onları yeniden bulursunuz.",
      anagramme: "Bu oyun bir kelimeyi sıraya koyar: harfler (veya heceler) karışıktır, onları yerine siz yerleştirirsiniz.",
      verif: "Bu oyun iki resmin birbirine uyup uymadığını sorar: evet ya da hayır dersiniz, kendi hızınızda."
    }
  },
  pl: {
    welcome: [
    ...
    explain: {
      ...
      croises: "To ćwiczenie to krzyżówka: każde szukane słowo jest pokazane obrazkiem.",
      memoire_liste: "To ćwiczenie ćwiczy pamięć roboczą: patrzysz na obrazki, a potem odnajdujesz je nieco później.",
      anagramme: "Ta gra układa słowo: litery (lub sylaby) są pomieszane, Ty je układasz z powrotem.",
      verif: "Ta gra pyta, czy dwa obrazki pasują do siebie: odpowiadasz tak lub nie, we własnym tempie."
    }
  },
  ja: {
    welcome: [
    ...
    explain: {
      ...
      croises: "この練習はクロスワードです。探す言葉はそれぞれ絵で示されます。",
      memoire_liste: "この練習はワーキングメモリを鍛えます。絵を見て、少しあとにもう一度見つけます。",
      anagramme: "このゲームは言葉を並べ直します。文字（または音節）がばらばらなので、正しく置き直します。",
      verif: "このゲームは二つの絵が合うかを尋ねます。「はい」か「いいえ」で、自分のペースで答えます。"
    }
  },
  // v6.112 : les phrases du compagnon "Ami" (46 par langue) manquaient
  // pour dz/ma/tn — jusqu'ici repli silencieux sur le français malgré
  // une interface par ailleurs traduite (repéré par l'utilisateur :
  // capture d'écran avec tout en arabe sauf le message d'Ami). Traduit
  // moi-même, même statut "premier jet" que le reste de l'interface
  // dz/ma/tn (v6.106-109) — PAS le kabyle : même raisonnement que pour
  // les questions de ressentis (docs/kabyle-symptoms-request.md),
  // phrases complètes en berbère hors de ma confiance sans relecture
  // native. Kabyle reste donc en repli français ici aussi.
  dz: {
    welcome: ['فرحانة نشوفك عاود!','واجد ملي تحب، نمشيو بشوية.','حصة جديدة، بالريتم تاعك.','راني هنا إذا حبيت يد تعاونك.'],
    welcome_back: ['فرحان نشوفك عاود، ما يهمش قداش قعدت!','رجعت، هادا المهم — نبداو بشوية.','فرحان بيك. نبداو براحتنا، بالريتم تاعك.'],
    insight_pointer: ['عندي نصيحة ليك تحت هنا 👇','شوف شنو لاحظت عليك، هنا تحت 👇','بدلت حاجة ليك — التفاصيل تحت هنا.'],
    tip: ['شوية كل يوم تعاون أكثر من حصة طويلة مرة في الشهر.','إذا راك تعبان، الراحة ديما فكرة مليحة — نكملو من بعد.','ماعندكش تنجح في كل شي: كل حصة تسوى، حتى الصعيبة.','تقدر تكتب الكود تاع المتابعة في بلاصة آمنة، باش تعطيه للأرتوفونيست إذا حبيت.'],
    exerciseStart: ['يالله نبداو، بشوية.','خود وقتك، ماكاش وقت محدد.','راني معاك طول التمرين.'],
    correct: ['برافو!','هادي هي بالضبط.','مليح بزاف!','مثالي، نكملو هكاك.'],
    streak: ['راك قوي، برافو!','ثلاثة على التوالي، انتظام زين!','مليح بزاف، كمل هكاك.'],
    encourage: ['ماشي مشكلة، نكملو.','ماشي حاجة، نمشيو بالريتم تاعك.','نجربو اللي بعدها، بشوية.','ماكاش مشكل، كل حصة تسوى.'],
    sessionEnd_high: ['حصة زينة، برافو على الخدمة تاعك!','حصة مليحة بزاف اليوم!'],
    sessionEnd_mid: ['حصة مليحة، شكرا اللي جيت.','هادي حصة زايدة، وتسوى.'],
    sessionEnd_low: ['شكرا اللي بقيت لحد الآخر، هادا اللي يسوى.','كل حصة تعاون، حتى ملي تكون أصعب.','نلتقاو للمرة الجاية، بالريتم تاعك.'],
    explain: {
      denomination: 'هاد التمرين يعاونك تلقى الكلمة اللي توافق الصورة، بشوية.',
      completion: 'هاد التمرين يدربك تلقى الكلمة الناقصة، باعتماد على معنى الجملة.',
      comprehension: 'هاد التمرين يخدم على فهم تعليمة بسيطة، بالريتم تاعك.',
      repetition: 'هاد التمرين يدرب النطق: تعاود كلمة، والتطبيق يسمعك.',
      denomination_orale: 'هنا، تقول اسم الصورة بصوت عالي، بلا خيارات تعاونك — تمرين مليح باش تلقى الكلمة وحدك.',
      fluence: 'هاد التمرين يحفز البحث السريع على الكلمات في فئة معينة.',
      intonation: 'هاد التمرين يخدم على التنغيم: سؤال، تعجب، جملة بسيطة.',
      photos_perso: 'هنا، تسمي الصور تاعك — كلمات معروفة عندك، لتمرين أكثر شخصي.',
      memory: 'هاد اللعبة تدرب الذاكرة البصرية، بلقاء ترتيب سلسلة صور — بلا ما تحتاج تهضر.',
      phonation: 'هاد التمرين يخدم على النفس: حافظ على صوت براحتك، بالريتم تاعك، بلا ما تحاول تعمل أحسن من قبل.',
      conversation: 'هنا، تتمرن على محادثة موجهة، خطوة بخطوة، كيما وضعية حقيقية من اليوميات.',
      association: 'التمرين هذا يعاونك تلقى شنو يمشي مع شنو، بلا ما تحتاج تهضر.',
      syntax: 'التمرين هذا يخدم على بناء الجملة: تعرف على الجملة المبنية مليح.',
      rhyme: 'التمرين هذا يخدم على صوت الكلمات: تعرف على الكلمات اللي كيفكيف فالصوت.',
      story: 'هاد التمرين يقترح عليك نص قصير تقراه، بعدها سؤال باش تشوف واش فهمت.'
    }
  },
  ma: {
    welcome: ['فرحانة نشوفك عاود!','واجد ملي تحب، نمشيو بشوية.','حصة جديدة، بالريتم ديالك.','راني هنا إذا حبيت يد تعاونك.'],
    welcome_back: ['فرحان نشوفك عاود، ما يهمش قداش قعدت!','رجعت، هادا المهم — نبداو بشوية.','فرحان بيك. نبداو براحتنا، بالريتم ديالك.'],
    insight_pointer: ['عندي نصيحة ليك تحت هنا 👇','شوف شنو لاحظت عليك، هنا تحت 👇','بدلت حاجة ليك — التفاصيل تحت هنا.'],
    tip: ['شوية كل يوم تعاون أكثر من حصة طويلة مرة في الشهر.','إذا راك تعبان، الراحة ديما فكرة مليحة — نكملو من بعد.','ماعندكش تنجح في كل شي: كل حصة تسوى، حتى الصعيبة.','تقدر تكتب الكود ديال المتابعة في بلاصة آمنة، باش تعطيه للأرتوفونيست إذا حبيت.'],
    exerciseStart: ['يالله نبداو، بشوية.','خود وقتك، ماكاش وقت محدد.','راني معاك طول التمرين.'],
    correct: ['برافو!','هادي هي بالضبط.','مليح بزاف!','مثالي، نكملو هكاك.'],
    streak: ['راك قوي، برافو!','ثلاثة على التوالي، انتظام زوين!','مزيان بزاف، كمل هكاك.'],
    encourage: ['ماشي مشكلة، نكملو.','ماشي حاجة، نمشيو بالريتم ديالك.','نجربو اللي بعدها، بشوية.','ماكاش مشكل، كل حصة تسوى.'],
    sessionEnd_high: ['حصة زوينة، برافو على الخدمة ديالك!','حصة مليحة بزاف اليوم!'],
    sessionEnd_mid: ['حصة مليحة، شكرا اللي جيت.','هادي حصة زايدة، وتسوى.'],
    sessionEnd_low: ['شكرا اللي بقيت لحد الآخر، هادا اللي يسوى.','كل حصة تعاون، حتى ملي تكون أصعب.','نلتقاو للمرة الجاية، بالريتم ديالك.'],
    explain: {
      denomination: 'هاد التمرين يعاونك تلقى الكلمة اللي توافق الصورة، بشوية.',
      completion: 'هاد التمرين يدربك تلقى الكلمة الناقصة، باعتماد على معنى الجملة.',
      comprehension: 'هاد التمرين يخدم على فهم تعليمة بسيطة، بالريتم ديالك.',
      repetition: 'هاد التمرين يدرب النطق: تعاود كلمة، والتطبيق يسمعك.',
      denomination_orale: 'هنا، تقول اسم الصورة بصوت عالي، بلا خيارات تعاونك — تمرين مليح باش تلقى الكلمة وحدك.',
      fluence: 'هاد التمرين يحفز البحث السريع على الكلمات في فئة معينة.',
      intonation: 'هاد التمرين يخدم على التنغيم: سؤال، تعجب، جملة بسيطة.',
      photos_perso: 'هنا، تسمي الصور ديالك — كلمات معروفة عندك، لتمرين أكثر شخصي.',
      memory: 'هاد اللعبة تدرب الذاكرة البصرية، بلقاء ترتيب سلسلة صور — بلا ما تحتاج تهضر.',
      phonation: 'هاد التمرين يخدم على النفس: حافظ على صوت براحتك، بالريتم ديالك، بلا ما تحاول تعمل أحسن من قبل.',
      conversation: 'هنا، تتمرن على محادثة موجهة، خطوة بخطوة، كيما وضعية حقيقية من اليوميات.',
      association: 'التمرين هذا كيعاونك تلقى شنو كيمشي مع شنو، بلا ما تحتاج تهضر.',
      syntax: 'التمرين هذا كيخدم على بناء الجملة: تعرف على الجملة المبنية مزيان.',
      rhyme: 'التمرين هذا كيخدم على صوت الكلمات: تعرف على الكلمات اللي كيفكيف فالصوت.',
      story: 'هاد التمرين كيقترح عليك نص قصير تقراه، من بعد سؤال باش تشوف واش فهمتي.'
    }
  },
  tn: {
    welcome: ['فرحانة نشوفك عاود!','واجد ملي تحب، نمشيو بشوية.','حصة جديدة، بالريتم متاعك.','راني هنا إذا حبيت يد تعاونك.'],
    welcome_back: ['فرحان نشوفك عاود، ما يهمش قداش قعدت!','رجعت، هادا المهم — نبداو بشوية.','فرحان بيك. نبداو براحتنا، بالريتم متاعك.'],
    insight_pointer: ['عندي نصيحة ليك تحت هنا 👇','شوف شنو لاحظت عليك، هنا تحت 👇','بدلت حاجة ليك — التفاصيل تحت هنا.'],
    tip: ['شوية كل يوم تعاون أكثر من حصة طويلة مرة في الشهر.','إذا راك تعبان، الراحة ديما فكرة مليحة — نكملو من بعد.','ماعندكش تنجح في كل شي: كل حصة تسوى، حتى الصعيبة.','تقدر تكتب الكود متاع المتابعة في بلاصة آمنة، باش تعطيه للأرتوفونيست إذا حبيت.'],
    exerciseStart: ['يالله نبداو، بشوية.','خود وقتك، ماكاش وقت محدد.','راني معاك طول التمرين.'],
    correct: ['برافو!','هادي هي بالضبط.','مليح برشا!','مثالي، نكملو هكاك.'],
    streak: ['راك قوي، برافو!','ثلاثة على التوالي، انتظام باهي!','باهي برشا، كمل هكاك.'],
    encourage: ['موش مشكلة، نكملو.','موش حاجة، نمشيو بالريتم متاعك.','نجربو اللي بعدها، بشوية.','ماكاش مشكل، كل حصة تسوى.'],
    sessionEnd_high: ['حصة باهية، برافو على الخدمة متاعك!','حصة مليحة برشا اليوم!'],
    sessionEnd_mid: ['حصة مليحة، شكرا اللي جيت.','هادي حصة زايدة، وتسوى.'],
    sessionEnd_low: ['شكرا اللي بقيت لحد الآخر، هادا اللي يسوى.','كل حصة تعاون، حتى ملي تكون أصعب.','نلتقاو للمرة الجاية، بالريتم متاعك.'],
    explain: {
      denomination: 'هاد التمرين يعاونك تلقى الكلمة اللي توافق الصورة، بشوية.',
      completion: 'هاد التمرين يدربك تلقى الكلمة الناقصة، باعتماد على معنى الجملة.',
      comprehension: 'هاد التمرين يخدم على فهم تعليمة بسيطة، بالريتم متاعك.',
      repetition: 'هاد التمرين يدرب النطق: تعاود كلمة، والتطبيق يسمعك.',
      denomination_orale: 'هنا، تقول اسم الصورة بصوت عالي، بلا خيارات تعاونك — تمرين مليح باش تلقى الكلمة وحدك.',
      fluence: 'هاد التمرين يحفز البحث السريع على الكلمات في فئة معينة.',
      intonation: 'هاد التمرين يخدم على التنغيم: سؤال، تعجب، جملة بسيطة.',
      photos_perso: 'هنا، تسمي الصور متاعك — كلمات معروفة عندك، لتمرين أكثر شخصي.',
      memory: 'هاد اللعبة تدرب الذاكرة البصرية، بلقاء ترتيب سلسلة صور — بلا ما تحتاج تهضر.',
      phonation: 'هاد التمرين يخدم على النفس: حافظ على صوت براحتك، بالريتم متاعك، بلا ما تحاول تعمل أحسن من قبل.',
      conversation: 'هنا، تتمرن على محادثة موجهة، خطوة بخطوة، كيما وضعية حقيقية من اليوميات.',
      association: 'التمرين هذا يعاونك تلقى شنية تمشي مع شنية، بلاش ما تحتاج تهضر.',
      syntax: 'التمرين هذا يخدم على بناء الجملة: تعرف على الجملة المبنية بالصح.',
      rhyme: 'التمرين هذا يخدم على صوت الكلمات: تعرف على الكلمات اللي يشبهو في الصوت.',
      story: 'هاد التمرين يقترح عليك نص قصير تقراه، بعدها سؤال باش تشوف كيفاش فهمت.'
    }
  },
    // v6.119 : 46 phrases du compagnon "Ami" en kabyle, fournies et
  // relues par le contact kabylophone de l'utilisateur — voir
  // docs/kabyle-glossary.md. Termine la parité pour cette banque.
  kab: {
    welcome: ['Tanemmirt imi d-tuɣaleḍ!','Mi theggaḍ, ad nebdu s lɣerḍ, s leḥnana.','Tiɣimit tamaynut, s lɣir-ik.','Lliɣ dagi ma tesriḍ tallelt.'],
    welcome_back: ['Igerrez imi d-tuɣaleḍ, akken ibɣu yili uwezɣi!','Tuɣaleḍ-d. D aya i yesɛan azal — ad nebdu s lɛqel.','Ferḥeɣ imi d-tuɣaleḍ. Ad nebdu s talwit, s lɣir-ik.'],
    insight_pointer: ['Sɛiɣ yiwen uwelleh i kečč, ddaw-a 👇','Wali ayen i d-gziɣ fell-ak, dagi ddaw-a 👇','Beddleɣ kra i kečč — tafat tella ddaw-a.'],
    tip: ['Cwiṭ yal ass yif tiɣimit taɣezfant tikwal.','Ma txesreḍ, kra n tsensert tettɛawan. Ad tuɣaleḍ mi tebɣiḍ.','Ur yessefk ara ad treḥḥeḍ deg yal taɣawsa. Yal tiɣimit tesɛa azal.','Tzemreḍ ad taruḍ tangalt-ik n uḍfar deg umkan aɣelsan, iwakken ad tt-tmuddeḍ i umeslay n tutlayt-ik ma tebɣiḍ.'],
    exerciseStart: ['Ad nebdu s talwit.','Err lwelha-k, ulac asrag.','Ad qqimeɣ yid-k deg usemdan.'],
    correct: ['Ih!','Ih, akka-t.','Igerrez!','Yelha, ad nekkemmel akka.'],
    streak: ['Tettkemmileḍ akken iwata, ih!','Kraḍ deg yiwet! Igerrez.','Asfari yella yelhan. Kemmel akka.'],
    encourage: ['Ur d acu ara. Ad nekkemmel.','Ur d acu ara. Ad neddu s lɣir-ik.','Ad nɛreḍ tin i d-iteddun, s talwit.','Ulac ugur. Yal tiɣimit tesɛa azal.'],
    sessionEnd_high: ['Tiɣimit telha aṭas. Tanemmirt ɣef uxeddim-ik!','Tiɣimit n wass-a telha aṭas!'],
    sessionEnd_mid: ['Tiɣimit telha. Tanemmirt imi d-tusiḍ.','D yiwet n teɣimit-nniḍen, yerna tesɛa azal.'],
    sessionEnd_low: ['Tanemmirt imi tkemmleḍ ar taggara. D aya i yesɛan azal.','Yal tiɣimit tettɛawan, ula ma tɛewwer.','Ad nemlil tikkelt i d-iteddun, s lɣir-ik.'],
    explain: {
      denomination: 'Asemdan-agi ad ak-iɛiwen ad tafeḍ awal yemṣadan akked tugna, s talwit.',
      completion: 'Asemdan-agi ad ak-iselmed amek ara tafeḍ awal ixuṣṣen s unamek n tefyirt.',
      comprehension: 'Asemdan-agi ad ak-iɛiwen ad tegzuḍ tanezricht taḥerfit, s lɣir-ik.',
      repetition: 'Asemdan-agi ad iselmed asusru. Alles awal, asnas ad ak-yesleḍ.',
      denomination_orale: 'Dagi, ini isem n tugna s taɣect meqqren, war afran ara ak-iɛiwnen. D aselmed yelhan iwakken ad tafeḍ awal s yiman-ik.',
      fluence: 'Asemdan-agi ad ikker anadi n wawalen deg yiwet n taggayt.',
      intonation: 'Asemdan-agi ad iselmed tenɣumnit : asteqsi, asiwel neɣ tafyirt taḥerfit.',
      photos_perso: 'Dagi, ad tesmiḍ tugniwin-ik. D awalen tessneḍ yakan, iwakken ad yili uselmed d win i k-yezdin.',
      memory: 'Urar-agi ad iselmed tazmert n tmekti n tugniwin, s tririt n umizzwer n tugniwin, war ma tesriḍ ad tmeslayeḍ.',
      phonation: 'Asemdan-agi ad ixeddem ɣef usuffeɣ n nnefs : eǧǧ yiwen n yimesli s lɛqel, s lɣir-ik, war ad tɛerḍeḍ ad tiliḍ yif wayen iɛeddan.',
      conversation: 'Dagi, ad teslemded amyannan yettunefken, amecwar s umecwar, amzun deg yiwet n tagnit n tudert n yal ass.'
    }
  }
};
...
const Companion = {
  ...
  // v6.202 : le hibou SEUL, sans bulle de texte — pour l'écran d'accueil,
  // où Ami se présente déjà par le texte de l'en-tête ("Je suis Ami…").
  // Réutilise svg() : une seule source pour le personnage, mêmes
  // animations, même respect de "réduire les animations" / lecture
  // facilitée (svg() n'insère pas les balises SMIL dans ces cas).
  renderAvatar(containerId, opts){
    const el = document.getElementById(containerId);
    if(!el) return;
    opts = opts || {};
    el.innerHTML = this.svg(opts.mood || 'happy', { pose: opts.pose || 'wave' });
  },
  ...
  explain(containerId, type){
    if(((window.Prefs && Prefs.data.amiLevel) || 'normal') === 'silencieux') return; // v6.191 ④
    if(!this.mounts.includes(containerId)) this.mounts.push(containerId);
  ...
  // v6.131 : message personnalisé (contient un mot précis, donc pas
  // puisable dans une banque de phrases fixes comme say()) — utilisé
  // pour signaler qu'un mot souvent raté vient d'être retrouvé (point
  // 10 de la demande d'amélioration). Réutilise l'humeur/pose de
  // "correct", ce message n'étant déclenché que sur une bonne réponse.
  sayText(text, important){
    // v6.191 ④ : Ami respecte le niveau choisi — « discret » ne garde
    // que l'important (célébrations), « silencieux » se tait vraiment.
    const lvl = (window.Prefs && Prefs.data.amiLevel) || 'normal';
    if(lvl !== 'normal' && !important) return;
    this.message = text;
    this.mood = this.moodFor('correct');
    this.pose = this.poseFor('correct');
    this.mounts.forEach(id=>this.render(id));
  },

  // Nom du personnage — v6.160 : signalé par l'utilisateur ("Ami"
  // reste "Ami" même dans des langues qui n'utilisent pas l'alphabet
  // latin). Le raisonnement d'origine ("comme ReParole reste
  // ReParole") tenait pour les langues en alphabet latin, mais pas
  // pour l'arabe ou le japonais : "Ami" y apparaît en lettres latines
  // au milieu d'un texte dans une tout autre écriture, illisible
  // phonétiquement pour un∙e lecteur∙rice de cette langue — pas la
  // même situation qu'un nom de marque affiché tel quel. Transcrit
  // phonétiquement dans l'écriture de la langue active (comme
  // n'importe quel nom étranger le serait naturellement — ex.
  // "Netflix" devient ネットフリックス en japonais) ; conservé "Ami"
  // pour les langues en alphabet latin, où le nom reste lisible et
  // reconnaissable tel quel.
  name(){
    const lang = (window.Prefs && Prefs.data.lang) || 'fr';
    const byLang = { ar:'آمي', ja:'アミ', dz:'آمي', ma:'آمي', tn:'آمي' }; // v6.160 : dz/ma/tn ajoutés — même écriture arabe que "ar", même besoin de transcription phonétique. kab utilise l'alphabet latin, "Ami" y reste lisible tel quel.
    return byLang[lang] || 'Ami';
  },
  ...
  render(containerId, opts){
    ...
    const el = document.getElementById(containerId);
    if(!el) return;
    // v6.198 : pas de bulle fantôme — si Ami n'a aucun message (ex : un
    // type d'exercice sans explication définie), on efface son widget
    // plutôt que d'afficher une bulle vide qui occupe l'espace (signalé
    // sur les mots croisés).
    if(!this.message){ el.innerHTML = ''; return; }
  ...
  svg(mood, opts){
    opts = opts || {};
    const mouths = {
      neutral:    'M 46 63 Q 50 64 54 63',
      happy:      'M 45 63 Q 50 66 55 63',
      delighted:  'M 44 63 Q 50 67 56 63',
      gentle:     'M 46 63 Q 50 64 54 63',
      proud:      'M 45 63 Q 50 66 55 63',
      calm:       'M 46 63 Q 50 65 54 63',
      thinking:   'M 46 63 Q 50 65 54 63',
      tired:      'M 46 64 Q 50 62 54 64',
      caring:     'M 46 63 Q 50 65 54 63',
      listening:  'M 46 63 Q 50 64 54 63'
    };
    ...
    const eyeRy = mood==='surprised' ? 7.5 : (mood==='tired' ? 1.5 : 6.5);
    ...
    // v6.203 : les bras deviennent des AILES repliées, plaquées aux
    // flancs du corps (fini l'ellipse brune détachée). Le salut lève
    // l'aile gauche (classe companion-arm-wave conservée pour le test).
    const wingL = 'M31 50 C19 58 20 80 33 91 C30 74 31 60 35 52 Z';
    const wingR = 'M69 50 C81 58 80 80 67 91 C70 74 69 60 65 52 Z';
    const wingUpL = 'M33 50 C21 41 15 25 21 15 C28 26 34 40 37 52 Z';
    const wingUpR = 'M67 50 C79 41 85 25 79 15 C72 26 66 40 63 52 Z';
    const poses = {
      neutral:  '<path class="companion-arm" d="'+wingL+'"/><path class="companion-arm" d="'+wingR+'"/>',
      wave:     '<path class="companion-arm companion-arm-wave" d="'+wingUpL+'"/><path class="companion-arm" d="'+wingR+'"/>',
      point:    '<path class="companion-arm" d="'+wingL+'"/><path class="companion-arm" d="M67 50 C83 47 91 35 88 25 C79 33 70 43 65 52 Z"/>',
      celebrate:'<path class="companion-arm companion-arm-wave" d="'+wingUpL+'"/><path class="companion-arm companion-arm-wave" d="'+wingUpR+'"/>',
      chin:     '<path class="companion-arm" d="'+wingR+'"/><path class="companion-arm" d="M52 54 C60 49 64 41 60 34 C54 41 50 48 48 54 Z"/>'
    };
    const armsMarkup = poses[opts.pose] || poses.neutral;

    // v6.200 : Ami devient un HIBOU (personnage validé par l'utilisateur).
    // Le squelette et TOUTES les classes testées sont conservés
    // (companion-body/belly/eye/mouth/leg/arm + accessoires + poses) : on
    // ne fait qu'AJOUTER les attributs de hibou (aigrettes, disques du
    // visage, bec) et redessiner via CSS. Les aigrettes frémissent
    // doucement — animation SVG native, coupée si reduced-motion, comme
    // les jambes et les yeux. Jamais d'agitation (charte ERGONOMIE).
    const earTwitchL = reduceMotion ? '' : '<animateTransform attributeName="transform" type="rotate" values="0 44 22;-8 44 22;0 44 22" keyTimes="0;0.5;1" dur="6s" repeatCount="indefinite"/>';
    const earTwitchR = reduceMotion ? '' : '<animateTransform attributeName="transform" type="rotate" values="0 56 22;8 56 22;0 56 22" keyTimes="0;0.5;1" dur="7s" repeatCount="indefinite"/>';
    ...
    return (
      '<div class="'+enterClass+'">'+
        '<svg class="companion-svg mood-'+mood+bobClass+'" viewBox="0 0 100 120" width="84" height="100" aria-hidden="true" focusable="false">'+
          '<defs><radialGradient id="ami-owl-body" cx="40%" cy="30%" r="80%">'+
            '<stop offset="0%" stop-color="#DBAA78"/><stop offset="55%" stop-color="#B7845A"/><stop offset="100%" stop-color="#8C5E37"/>'+
          '</radialGradient></defs>'+
          '<path class="companion-leg" d="M42 97 l-5 8 M42 97 l0 9 M42 97 l5 8">'+legLeftAnim+'</path>'+
          '<path class="companion-leg" d="M58 97 l-5 8 M58 97 l0 9 M58 97 l5 8">'+legRightAnim+'</path>'+
          armsMarkup+
          // v6.203 : la bouche est dessinée DERRIÈRE le corps → invisible.
          // Le hibou n'a qu'un bec (demande utilisateur). L'élément
          // companion-mouth reste présent, avec un tracé qui varie par
          // humeur, pour rester conforme au test companion-gestures.
          mouthMarkup+
          '<path class="companion-ear" d="M 40 20 L 33 3 L 52 16 Z">'+earTwitchL+'</path>'+
          '<path class="companion-ear" d="M 60 20 L 67 3 L 48 16 Z">'+earTwitchR+'</path>'+
          '<path class="companion-body" d="M50 14 C27 14 19 35 19 59 C19 85 34 101 50 101 C66 101 81 85 81 59 C81 35 73 14 50 14 Z"/>'+
          '<ellipse class="companion-belly" cx="50" cy="70" rx="19" ry="22"/>'+
          '<path d="M50 58 q5 6 0 12 q-5 6 0 12" fill="none" stroke="#D9C39A" stroke-width="1.3" stroke-linecap="round" opacity="0.65"/>'+
          '<circle class="companion-disc" cx="37" cy="44" r="17"/>'+
          '<circle class="companion-disc" cx="63" cy="44" r="17"/>'+
          '<circle cx="37" cy="44" r="11.5" fill="#fff"/>'+
          '<circle cx="63" cy="44" r="11.5" fill="#fff"/>'+
          '<ellipse class="companion-eye" cx="37" cy="45" rx="6.5" ry="'+eyeRy+'">'+eyeAnim+'</ellipse>'+
          '<ellipse class="companion-eye" cx="63" cy="45" rx="6.5" ry="'+eyeRy+'">'+eyeAnim+'</ellipse>'+
          '<circle cx="40" cy="41.5" r="2.6" fill="#fff"/>'+
          '<circle cx="66" cy="41.5" r="2.6" fill="#fff"/>'+
          '<path class="companion-beak" d="M 50 50 L 45 55 Q 50 63 55 55 Z"/>'+
          accessory+
        '</svg>'+
      '</div>'
    );
