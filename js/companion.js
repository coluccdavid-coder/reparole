    ...
    return (
      '<div class="'+enterClass+'">'+
        '<svg class="companion-svg mood-'+mood+bobClass+'" viewBox="0 0 100 120" width="84" height="100" aria-hidden="true" focusable="false">'+
          ...
          armsMarkup+
          '<path class="companion-ear" d="M 40 20 L 32 2 L 53 15 Z">'+earTwitchL+'</path>'+
          '<path class="companion-ear" d="M 60 20 L 68 2 L 47 15 Z">'+earTwitchR+'</path>'+
          '<ellipse class="companion-body" cx="50" cy="53" rx="34" ry="31"/>'+
          '<ellipse class="companion-belly" cx="50" cy="68" rx="20" ry="15"/>'+
          '<circle class="companion-disc" cx="38" cy="44" r="15.5"/>'+
          '<circle class="companion-disc" cx="62" cy="44" r="15.5"/>'+
          '<circle cx="38" cy="44" r="9.5" fill="#fff"/>'+
          '<circle cx="62" cy="44" r="9.5" fill="#fff"/>'+
          '<ellipse class="companion-eye" cx="38" cy="45" rx="5.6" ry="'+eyeRy+'">'+eyeAnim+'</ellipse>'+
          '<ellipse class="companion-eye" cx="62" cy="45" rx="5.6" ry="'+eyeRy+'">'+eyeAnim+'</ellipse>'+
          '<circle cx="40.5" cy="42" r="2" fill="#fff"/>'+
          '<circle cx="64.5" cy="42" r="2" fill="#fff"/>'+
          '<path class="companion-beak" d="M 50 48 L 45.5 53 Q 50 60 54.5 53 Z"/>'+
          mouthMarkup+
          accessory+
        '</svg>'+
      '</div>'
