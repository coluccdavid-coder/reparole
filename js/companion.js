...
const COMPANION_PHRASES = {
  ...
  // native. Kabyle reste donc en repli français ici aussi.
    ...
    streak: ['راك ماشي مليح، برافو!','ثلاثة على التوالي، انتظام زين!','ماشي مليح بزاف، كمل هكاك.'],
  ...
  ma: {
    ...
    exerciseStart: ['يالله نبداو، بشوية.','خود وقتك، ماكاش وقت محدد.','راني معاك طول التمرين.'],
    correct: ['برافو!','هادي هي بالضبط.','مليح بزاف!','مثالي، نكملو هكاك.'],
    streak: ['راك ماشي مليح، برافو!','ثلاثة على التوالي، انتظام زوين!','ماشي مليح بزاف، كمل هكاك.'],
  ...
  tn: {
    ...
    streak: ['راك موش مليح، برافو!','ثلاثة على التوالي، انتظام باهي!','موش مليح برشا، كمل هكاك.'],
