...
// v6.209 : le mur payant patient s'active selon le réglage admin
...
async function attemptAutoLogin(){
  applyBillingPaywall(); // v6.209 : branche le mur payant sur le réglage admin (fire-and-forget)
...
async function createNewPatient(){
  ...
  // v6.209 : la création a son PROPRE champ prénom (#new-name), dans le
...
// v6.209 : copier la clé personnelle en un geste (réduit le risque de la perdre).
