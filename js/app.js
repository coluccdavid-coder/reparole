...
// "rhyme" (Rimes) n'est PAS concerné : une rime ne se traduit dans
// AUCUNE langue (même anglais/espagnol), c'est une limite déjà
// documentée et acceptée pour tout le monde, pas un manque de
// traduction spécifique — voir js/exercises-new-types.js.
const FRENCH_ONLY_EXERCISE_TYPES = ['syntax', 'story'];
