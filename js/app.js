...
// v6.219 : le mur payant patient s'active selon le réglage admin
...
async function attemptAutoLogin(){
  applyBillingPaywall(); // v6.219 : branche le mur payant sur le réglage admin (fire-and-forget)
  // v6.219 : arrivée depuis la vitrine (accueil.html, « Je commence »)
  ...
  // v6.219 : liens profonds depuis la vitrine (accueil.html) — un seul
...
async function createNewPatient(){
  ...
  // v6.219 : la création a son PROPRE champ prénom (#new-name), dans le
...
// v6.219 : copier la clé personnelle en un geste (réduit le risque de la perdre).
