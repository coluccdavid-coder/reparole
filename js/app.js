...
function renderAnagramme(q, body){
  ...
  body.innerHTML=`
    <div class="prompt-card">
      <div class="emoji" style="font-size:3.4rem">${q.emoji||'❓'}</div>
    ...
    <button type="button" class="btn-ghost" id="anagram-erase" style="margin-top:14px">↺ ${I18N.t('game_erase')}</button>`;
...
function renderVerif(q, body){
  ...
  body.innerHTML=`
    <div class="prompt-card">
      <div class="emoji" style="font-size:3.4rem">${q.emoji||'❓'}</div>
      <div style="font-size:1.5rem;font-weight:700;margin-top:10px">${escapeHTML(q.word)}</div>
    </div>
    <div style="display:flex;gap:14px;justify-content:center;margin-top:18px;flex-wrap:wrap">
      <button type="button" class="btn-primary" id="verif-yes" style="min-width:150px;min-height:60px;font-size:1.1rem">✅ ${I18N.t('game_yes')}</button>
      <button type="button" class="btn-ghost" id="verif-no" style="min-width:150px;min-height:60px;font-size:1.1rem">✋ ${I18N.t('game_no')}</button>
    </div>`;
