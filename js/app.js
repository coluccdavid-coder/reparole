...
// v6.241 : le mur payant patient s'active selon le réglage admin
...
async function applyBillingPaywall(){
  try{
    ...
    // v6.241 : la case « Patients : passer au payant » pilote seule le mur
...
function pickVoiceForSpeech(){
  ...
  // v6.241 : jusqu'ici on prenait la PREMIÈRE voix de la liste, souvent la
...
function speakBrowserTTS(text){
  ...
  u.rate = 0.94; u.pitch = 1.02;  // v6.241 : débit/hauteur plus naturels
...
async function attemptAutoLogin(){
  applyBillingPaywall(); // v6.241 : branche le mur payant sur le réglage admin (fire-and-forget)
  // v6.241 : arrivée depuis la vitrine (accueil.html, « Je commence »)
  ...
  // v6.241 : liens profonds depuis la vitrine (accueil.html) — un seul
...
async function createNewPatient(){
  ...
  // v6.241 : la création a son PROPRE champ prénom (#new-name), dans le
...
// v6.241 : copier la clé personnelle en un geste (réduit le risque de la perdre).
...
// =====================================================================
//  v6.241 — ICÔNES MODERNES (espace patient)
//  ---------------------------------------------------------------------
