...
// v6.225 : le mur payant patient s'active selon le réglage admin
...
function pickVoiceForSpeech(){
  ...
  // v6.225 : jusqu'ici on prenait la PREMIÈRE voix de la liste, souvent la
...
function speakBrowserTTS(text){
  ...
  u.rate = 0.94; u.pitch = 1.02;  // v6.225 : débit/hauteur plus naturels
...
async function attemptAutoLogin(){
  applyBillingPaywall(); // v6.225 : branche le mur payant sur le réglage admin (fire-and-forget)
  // v6.225 : arrivée depuis la vitrine (accueil.html, « Je commence »)
  ...
  // v6.225 : liens profonds depuis la vitrine (accueil.html) — un seul
...
async function createNewPatient(){
  ...
  // v6.225 : la création a son PROPRE champ prénom (#new-name), dans le
...
// v6.225 : copier la clé personnelle en un geste (réduit le risque de la perdre).
...
// =====================================================================
//  v6.225 — ICÔNES MODERNES (espace patient)
//  ---------------------------------------------------------------------
