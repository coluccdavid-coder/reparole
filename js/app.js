...
// v6.220 : le mur payant patient s'active selon le réglage admin
...
async function attemptAutoLogin(){
  applyBillingPaywall(); // v6.220 : branche le mur payant sur le réglage admin (fire-and-forget)
  // v6.220 : arrivée depuis la vitrine (accueil.html, « Je commence »)
  ...
  // v6.220 : liens profonds depuis la vitrine (accueil.html) — un seul
...
async function createNewPatient(){
  ...
  // v6.220 : la création a son PROPRE champ prénom (#new-name), dans le
...
// v6.220 : copier la clé personnelle en un geste (réduit le risque de la perdre).
