...
const FRENCH_ONLY_EXERCISE_TYPES = ['syntax', 'story', 'rhyme', 'heure', 'monnaie', 'calcul_quotidien', 'comparaison_nombres', 'prix']; // v6.156 : les 5 exercices d'acalculie rejoignent cette liste — même situation que syntax/story à l'origine (v6.146), pas encore de contenu traduit
