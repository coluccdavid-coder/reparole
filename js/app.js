...
// v6.229 : le mur payant patient s'active selon le réglage admin
...
function pickVoiceForSpeech(){
  ...
  // v6.229 : jusqu'ici on prenait la PREMIÈRE voix de la liste, souvent la
...
function speakBrowserTTS(text){
  ...
  u.rate = 0.94; u.pitch = 1.02;  // v6.229 : débit/hauteur plus naturels
...
async function attemptAutoLogin(){
  applyBillingPaywall(); // v6.229 : branche le mur payant sur le réglage admin (fire-and-forget)
  // v6.229 : arrivée depuis la vitrine (accueil.html, « Je commence »)
  ...
  // v6.229 : liens profonds depuis la vitrine (accueil.html) — un seul
...
async function createNewPatient(){
  ...
  // v6.229 : la création a son PROPRE champ prénom (#new-name), dans le
...
// v6.229 : copier la clé personnelle en un geste (réduit le risque de la perdre).
...
// =====================================================================
//  v6.229 — ICÔNES MODERNES (espace patient)
//  ---------------------------------------------------------------------
