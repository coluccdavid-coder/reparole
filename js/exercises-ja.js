...
window.BANK_JA = {
  ...
  // =====================================================================
  //  v6.151 — 3 EXERCICES VOCAUX MANQUANTS, COMBLÉS
  //  ---------------------------------------------------------------------
  //  Trouvé en préparant l'infrastructure des voix cloud (v6.150) : le
  //  japonais, listé comme langue "complète" depuis la v6.91, n'avait
  //  en fait jamais eu denomination_orale, repetition, ni intonation —
  //  contrairement aux 8 autres langues complètes. Découvert en
  //  comparant les comptages de contenu EN vs JA pendant l'extraction
  //  du texte à voix, jamais remarqué avant (ces 3 exercices reposent
  //  sur le micro, jamais testés automatiquement de la même façon que
  //  les exercices à choix multiple).
  //
  //  repetition (niveau 3) : mots volontairement longs/complexes,
  //  même logique que les langues complètes (ex. l'anglais utilise
  //  "otorhinolaryngologist") — l'équivalent japonais choisi ici
  //  privilégie de vrais mots composés longs (医者 → 耳鼻咽喉科医,
  //  etc.), pas une traduction terme à terme de la liste anglaise.
  // =====================================================================
  denomination_orale:{ title:'声に出して名前を言う', voice:true, items:{
    1:[ {emoji:'🐱',word:'猫'},{emoji:'🍎',word:'りんご'},{emoji:'🏠',word:'家'},{emoji:'☀️',word:'太陽'},{emoji:'🚗',word:'車'},{emoji:'🌹',word:'バラ'} ],
    2:[ {emoji:'🦋',word:'蝶'},{emoji:'⌚',word:'腕時計'},{emoji:'🍄',word:'きのこ'},{emoji:'🦒',word:'キリン'},{emoji:'⛵',word:'ヨット'},{emoji:'🎺',word:'トランペット'} ],
    3:[ {emoji:'🧭',word:'コンパス'},{emoji:'🦔',word:'ハリネズミ'},{emoji:'⚓',word:'錨'},{emoji:'🔬',word:'顕微鏡'},{emoji:'🌪️',word:'竜巻'},{emoji:'🛡️',word:'盾'} ]
  }},
  repetition:{ title:'声に出して繰り返す', voice:true, items:{
    1:[ {word:'ボール'},{word:'テーブル'},{word:'太陽'},{word:'猫'},{word:'ドア'},{word:'花'},{word:'手'},{word:'水'} ],
    2:[ {word:'コンピューター'},{word:'傘'},{word:'電話'},{word:'図書館'},{word:'レストラン'},{word:'山'},{word:'庭師'},{word:'カレンダー'} ],
    3:[ {word:'ヘリコプター'},{word:'理学療法士'},{word:'平行六面体'},{word:'耳鼻咽喉科医'},{word:'統計学的に'},{word:'気象予報士'},{word:'図書館司書'},{word:'新幹線特急券'} ]
  }},
  intonation:{ title:'抑揚をつけて繰り返す', voice:true, items:{
    1:[ {word:'もう終わりましたか？',cue:'question'},
        {word:'本当に大丈夫ですか？',cue:'question'},
        {word:'明日行きます。',cue:'descriptive'},
        {word:'ここで食べます。',cue:'descriptive'},
        {word:'こっちに来て！',cue:'exclamative'},
        {word:'なんていい考えなんだ！',cue:'exclamative'} ],
    2:[ {word:'何をしているのですか？',cue:'question'},
        {word:'本当に？',cue:'question'},
        {word:'彼女は外で遊んでいます。',cue:'descriptive'},
        {word:'彼らは友達と話しています。',cue:'descriptive'},
        {word:'なんて綺麗なんでしょう！',cue:'exclamative'},
        {word:'なんて驚きだ！',cue:'exclamative'} ],
    3:[ {word:'昨夜はよく眠れましたか？',cue:'question'},
        {word:'これを運ぶのを手伝ってもらえますか？',cue:'question'},
        {word:'明日の朝早く出発します。',cue:'descriptive'},
        {word:'あなたが眠っている間に郵便屋さんが来ました。',cue:'descriptive'},
        {word:'なんて素晴らしい一日だったんでしょう！',cue:'exclamative'},
        {word:'まだ信じられません！',cue:'exclamative'} ]
  }},
  // =====================================================================
  //  v6.161 — VRAI TROU TROUVÉ ET COMBLÉ : "fluence" manquait entièrement
  //  pour le japonais, contrairement aux 8 autres langues complètes.
  //  Contrairement à kab/dz/ma/tn (repli français ANNONCÉ, car ces
  //  langues n'ont pas de synthèse/reconnaissance vocale du tout), le
  //  japonais A un vrai support vocal — donc ce trou précis tombait
  //  dans un repli SILENCIEUX (voir startExercise() dans js/app.js),
  //  affichant "Fluence verbale" en français au milieu d'une interface
  //  japonaise. Trouvé en auditant systématiquement les 4 domaines
  //  "cœur" du produit (langage/parole/mémoire/acalculie) à travers
  //  toutes les langues, pas par un signalement utilisateur cette fois.
  // =====================================================================
  fluence:{ title:'言葉の流暢性', voice:true, fluency:true, items:{
    1:[ {cat:'動物',accept:['ねこ','いぬ','うさぎ','うま','うし','にわとり','ひつじ','ぶた','とり','さかな','ねずみ','らいおん','とら','くま','おおかみ','きつね','あひる','ろば','やぎ','さる','ぞう','きりん','しまうま','へび','かえる']},
        {cat:'果物',accept:['りんご','なし','ばなな','おれんじ','いちご','さくらんぼ','ぶどう','きうい','めろん','もも','あんず','ぷらむ','れもん','ぱいなっぷる','まんごー','らずべりー','ぶるーべりー','すいか','いちじく','みかん']} ],
    2:[ {cat:'台所の道具',accept:['ほうちょう','ふぉーく','すぷーん','さら','こっぷ','なべ','ふらいぱん','おーぶん','れいぞうこ','ながし','てーぶる','かっぷ','ぼうる','ざる','へら','おたま','しょっき','やかん','てぃーぽっと']},
        {cat:'服',accept:['ずぼん','しゃつ','せーたー','どれす','すかーと','こーと','じゃけっと','くつした','くつ','まふらー','てぶくろ','ぼうし','たんぱん','てぃーしゃつ','ねくたい','べると','ぶーつ','さんだる','たいつ','かーでぃがん']} ],
    3:[ {cat:'「か」から始まる言葉',accept:['かさ','かがみ','かぞく','かいしゃ','かめら','かいだん','かびん','かぶ','かに','かえで','かもめ','かご','かわ','かぜ','かがく','かんじ','かみ','かたち','かべ','かど']},
        {cat:'職業',accept:['いしゃ','ぱんや','しょうぼうし','せんせい','かんごし','べんごし','はいかんこう','がか','りょうりにん','ゆうびんはいたついん','にわし','びようし','きかいこう','やくざいし','でんきぎし','けんちくか','じゃーなりすと','けいさつかん','ぱいろっと','しかい']} ]
  }}
};
