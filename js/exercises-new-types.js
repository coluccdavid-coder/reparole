...
window.BANK_EXTEND({
  association:{ title:'Associer les images', items:{
    ...
    2:[ // v6.177 : 🔨→🪵 ("le marteau va avec le bois" ?) remplacé par
        // 🪚→🪵 — la scie va avec le bois, association limpide. Il
        // n'existe pas d'emoji "clou" pour le couple marteau/clou.
        {text:'🪚',answer:'🪵',choices:['🪵','🍞','📖']},
        {text:'🌱',answer:'🌻',choices:['🌻','❄️','🚗']},
        {text:'✉️',answer:'📬',choices:['📬','🍎','🔑']},
        {text:'🎣',answer:'🐟',choices:['🐟','🐦','🚲']},
  ...
  // v6.143 — point 6 de la demande d'amélioration, repris après un
  // premier refus trop rapide (voir historique) : reconnaissance de
  // rimes. Réutilise le mécanisme de rendu générique déjà en place
  // (comme "syntax") — le texte de la question passe déjà par
  // speak() via le bouton "Écouter la consigne" existant, ce qui
  // donne une vraie exposition auditive au mot cible SANS avoir
  // besoin de vrais fichiers audio (que je ne peux pas produire de
  // façon fiable). Paires qui riment vraiment en français (même son
  // final), pas de simple ressemblance orthographique.
  rhyme:{ title:'Rimes', items:{
    1:[ {text:'Quel mot rime avec « CHAT » ?',answer:'RAT',choices:['RAT','CHIEN','LIVRE']},
        {text:'Quel mot rime avec « BALLON » ?',answer:'MAISON',choices:['MAISON','TABLE','VOITURE']},
        {text:'Quel mot rime avec « CHOU » ?',answer:'LOUP',choices:['LOUP','PAIN','ROBE']},
        {text:'Quel mot rime avec « NEZ » ?',answer:'THÉ',choices:['THÉ','MAIN','PORTE']},
        {text:'Quel mot rime avec « FLEUR » ?',answer:'COULEUR',choices:['COULEUR','ARBRE','SOLEIL']},
        {text:'Quel mot rime avec « MAIN » ?',answer:'TRAIN',choices:['TRAIN','PIED','MER']},
        {text:'Quel mot rime avec « BOL » ?',answer:'VOL',choices:['VOL','TASSE','LUNE']},
        {text:'Quel mot rime avec « ROSE » ?',answer:'CHOSE',choices:['CHOSE','FLEUR','LIVRE']} ],
    2:[ {text:'Quel mot rime avec « MONTAGNE » ?',answer:'CAMPAGNE',choices:['CAMPAGNE','RIVIÈRE','VILLE']},
        {text:'Quel mot rime avec « JARDIN » ?',answer:'CHEMIN',choices:['CHEMIN','FORÊT','MER']},
        {text:'Quel mot rime avec « VOITURE » ?',answer:'AVENTURE',choices:['AVENTURE','BATEAU','TRAIN']},
        {text:'Quel mot rime avec « CHAPEAU » ?',answer:'BATEAU',choices:['BATEAU','TABLE','CHAISE']},
        {text:'Quel mot rime avec « SOURIS » ?',answer:'PARIS',choices:['PARIS','CHAT','MAISON']},
        {text:'Quel mot rime avec « GÂTEAU » ?',answer:'RIDEAU',choices:['RIDEAU','FENÊTRE','PORTE']},
        {text:'Quel mot rime avec « PLAGE » ?',answer:'NUAGE',choices:['NUAGE','MONTAGNE','RIVIÈRE']},
        {text:'Quel mot rime avec « ÉCOLE » ?',answer:'PAROLE',choices:['PAROLE','MAISON','JARDIN']} ],
    3:[ {text:'Quel mot rime avec « LIBERTÉ » ?',answer:'VÉRITÉ',choices:['VÉRITÉ','BONHEUR','COURAGE']},
        {text:'Quel mot rime avec « AMITIÉ » ?',answer:'PITIÉ',choices:['PITIÉ','JUSTICE','PATIENCE']},
        {text:'Quel mot rime avec « BONHEUR » ?',answer:'COULEUR',choices:['COULEUR','TRISTESSE','SAGESSE']},
        {text:'Quel mot rime avec « VOYAGE » ?',answer:'PAYSAGE',choices:['PAYSAGE','SILENCE','DISTANCE']},
        {text:'Quel mot rime avec « SILENCE » ?',answer:'PATIENCE',choices:['PATIENCE','COURAGE','MYSTÈRE']},
        {text:'Quel mot rime avec « NUMÉRO » ?',answer:'VÉLO',choices:['VÉLO','HISTOIRE','MUSIQUE']},
        {text:'Quel mot rime avec « HISTOIRE » ?',answer:'MÉMOIRE',choices:['MÉMOIRE','LUMIÈRE','NATURE']},
        {text:'Quel mot rime avec « NATURE » ?',answer:'AVENTURE',choices:['AVENTURE','HISTOIRE','SILENCE']} ]
  }}
});
