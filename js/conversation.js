...
const Conversation = {
  ...
  toggleListen(){
    ...
    recognition.onresult=(e)=>{
      ...
      heard.innerHTML=`${I18N.t('heard_label')} <b>« ${escapeHTML(said)} »</b>`;
...
// v6.165 : CONV_SCENARIOS_JA — trouvé manquant lors de l'audit complet
// demandé par l'utilisateur. Le japonais était la seule des 9 langues
// complètes sans scénarios de conversation, repliant silencieusement
// sur le français (avec un bandeau d'avertissement déjà en place,
// "conversation_untranslated_note" — pas un mélange totalement
// silencieux, mais un vrai manque de contenu à combler). Brouillon de
// ma part, même statut que le reste du contenu — à faire vérifier par
// un∙e locuteur∙rice natif∙ve avant tout usage clinique réel.
window.CONV_SCENARIOS_JA = {
  medecin:{
    title:'病院で',
    icon:'🩺',
    steps:[
      { ai:"こんにちは！今日はどうされましたか？",
        accept:["いたいです","たいちょうがわるいです","もんだいがあります","けんしんにきました","しんさつにきました"],
        choices:["いたいです。","けんしんにきました。","たいちょうがわるいです。"] },
      { ai:"どこがいたいですか？",
        accept:["あたま","おなか","せなか","うで","あし","どこも"],
        choices:["あたまです。","せなかです。","どこもいたくないです、けんしんです。"] },
      { ai:"いつからですか？",
        accept:["きのうから","いっしゅうかんまえから","まえから","けさから"],
        choices:["きのうからです。","いっしゅうかんまえからです。","けさからです。"] },
      { ai:"わかりました、ありがとうございます。しつもんはありますか？",
        accept:["はい","いいえ","しつもんがあります"],
        choices:["いいえ、だいじょうぶです。","はい、しつもんがあります。"] }
    ]
  },
  cafe:{
    title:'カフェで',
    icon:'☕',
    steps:[
      { ai:"いらっしゃいませ、なにになさいますか？",
        accept:["コーヒー","おちゃ","オレンジジュース","おみず","ホットチョコレート"],
        choices:["コーヒーをおねがいします。","おちゃをください。","おみずをください。"] },
      { ai:"てんないでめしあがりますか、おもちかえりですか？",
        accept:["てんない","もちかえり"],
        choices:["てんないでおねがいします。","もちかえりです。"] },
      { ai:"ほかになにかごいっしょにいかがですか？",
        accept:["いいえけっこうです","はいクロワッサンを","はいケーキを"],
        choices:["いいえ、けっこうです。","はい、クロワッサンをおねがいします。"] },
      { ai:"かしこまりました、さんユーロごじゅっセントです。よいいちにちを！",
        accept:["ありがとう","さようなら","どうもありがとうございます"],
        choices:["ありがとうございます、さようなら。","どうもありがとうございます。"] }
    ]
  },
  telephone:{
    title:'でんわ',
    ...
    steps:[
      { ai:"もしもし？",
        accept:["こんにちは","もしもしこんにちは","もしもし"],
        choices:["こんにちは。","もしもし、こんにちは。"] },
      { ai:"どちらさまですか？",
        accept:["わたしです","のかわりにでんわしています"],
        choices:["わたしです。","かわりにおでんわしています。"] },
      { ai:"よやくのためにおでんわしました。どのひがつごうがいいですか？",
        accept:["げつようび","かようび","すいようび","もくようび","きんようび","なんようびでも"],
        choices:["げつようびです。","すいようびです。","なんようびでもだいじょうぶです。"] },
      { ai:"かしこまりました、きろくしました。よいいちにちを！",
        accept:["ありがとう","さようなら","そちらもよいいちにちを"],
        choices:["ありがとうございます、さようなら。","そちらもよいいちにちを。"] }
    ]
  }
};
