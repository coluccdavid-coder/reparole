...
const ASSESS_ITEMS_KAB = {
  denomination:[
    // aqjun = chien / amcic = chat : confirmés par relecture native (v6.113,
    // docs/kabyle-glossary.md) — aɛewdiw = cheval toujours non vérifié,
    // et en conflit possible avec "agmar" déjà utilisé ailleurs pour
    // cheval (voir docs/kabyle-glossary.md, "points à trancher").
    ...
    // v6.115 : la relecture native propose "Tafradit" (vélo) et "Ttamubil"
    // (voiture) à la place — conflit non tranché, voir docs/kabyle-glossary.md.
    // Pas changé ici tant que ce n'est pas résolu.
  ...
  // completion : reste en français (il manque encore 1 des 3 phrases —
  // voir docs/kabyle-symptoms-request.md).
