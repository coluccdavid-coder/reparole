...
// v6.125 : manquait entièrement pour le japonais — repéré par
// l'utilisateur (capture d'écran : "あなたの気持ち" et le bouton d'écoute
// bien en japonais, mais la question et les réponses en français en
// dessous). Contrairement au kabyle, le japonais est une langue
// "complète" traitée avec la même confiance que les 8 autres langues
// complètes (en/es/it/pt/de/ar/tr/pl) qui ont toutes cette banque —
// simple oubli à l'origine, comblé ici selon le même modèle.
window.ASSESS_DOMAIN_LABELS_JA = {
  denomination:'ものの名前を見つける',
  completion:'文を完成させる',
  comprehension:'指示を理解する'
};
...
window.ASSESS_DOMAIN_LABELS_DZ = {
  denomination:'سمي الأشياء',
  completion:'كمل الجملة',
  comprehension:'افهم'
};
window.ASSESS_DOMAIN_LABELS_MA = {
  denomination:'سمي الأشياء',
  completion:'كمل الجملة',
  comprehension:'افهم'
};
window.ASSESS_DOMAIN_LABELS_TN = {
  denomination:'سمي الأشياء',
  completion:'كمل الجملة',
  comprehension:'افهم'
};
...
window.SYMPTOM_QUESTIONS_DZ = [
  { key:'mots',   q:'واش يصرالك تقلب على الكلمات؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'compr',  q:'عندك صعوبة تفهم شنو يقولولك؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'parole', q:'الكلام تاعك صعيب باش تنطقو؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'lecture',q:'القراية تطلب منك مجهود كبير؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] }
];
window.SYMPTOM_QUESTIONS_MA = [
  { key:'mots',   q:'واش يصرالك تقلب على الكلمات؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'compr',  q:'عندك صعوبة تفهم شنو يقولولك؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'parole', q:'الكلام ديالك صعيب باش تنطقو؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'lecture',q:'القراية تطلب منك مجهود كبير؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] }
];
window.SYMPTOM_QUESTIONS_TN = [
  { key:'mots',   q:'واش يصرالك تقلب على الكلمات؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'compr',  q:'عندك صعوبة تفهم شنو يقولولك؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'parole', q:'الكلام متاعك صعيب باش تنطقو؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] },
  { key:'lecture',q:'القراية تطلب منك مجهود كبير؟',
    options:[['بزاف',2],['شوية',1],['قليل',0]] }
];
...
// v6.125 : manquait entièrement pour le japonais (voir commentaire sur
// ASSESS_DOMAIN_LABELS_JA plus haut pour le contexte du repérage).
window.SYMPTOM_QUESTIONS_JA = [
  { key:'mots',   q:'言葉が出てこないことがありますか？',
    options:[['よくある',2],['時々',1],['めったにない',0]] },
  { key:'compr',  q:'言われたことを理解するのが難しいことがありますか？',
    options:[['よくある',2],['時々',1],['めったにない',0]] },
  { key:'parole', q:'話す時、発音するのが難しいですか？',
    options:[['よくある',2],['時々',1],['めったにない',0]] },
  { key:'lecture',q:'読むことに多くの努力が必要ですか？',
    options:[['よくある',2],['時々',1],['めったにない',0]] }
];
...
window.ASSESS_ITEMS_DZ = {
  denomination:[
    {emoji:'🐶',answer:'الكلب',choices:['الكلب','القط','الحصان']},
    {emoji:'🚲',answer:'البيسكليت',choices:['البيسكليت','الموطو','الكرهبة']},
    {emoji:'🌧️',answer:'الشتا',choices:['الشتا','الثلج','الشمس']}
  ],
  completion:[
    {text:'نشرب القهوة فـ ___',answer:'الكاس',choices:['الكاس','الكرسي','الباب']},
    {text:'بالليل، نشوف ___',answer:'القمر',choices:['القمر','الطابلة','اليد']},
    {text:'باش نقطع الخبز، نستعمل ___',answer:'الموس',choices:['الموس','الكتاب','الكاس']}
  ],
  comprehension:[
    {text:'شنو الحيوان اللي يطير؟',answer:'الطير',choices:['الطير','الكلب','الحوت']},
    {text:'وين نحطو الكتب؟',answer:'فالرف',choices:['فالرف','فالتلاجة','فالبانيو']},
    {text:'شنو ندير بالمقص؟',answer:'نقص',choices:['نقص','نشرب','نرقد']}
  ]
};
window.ASSESS_ITEMS_MA = {
  denomination:[
    {emoji:'🐶',answer:'الكلب',choices:['الكلب','القط','الحصان']},
    {emoji:'🚲',answer:'البيسكليت',choices:['البيسكليت','الموطو','الطوموبيل']},
    {emoji:'🌧️',answer:'الشتا',choices:['الشتا','الثلج','الشمس']}
  ],
  completion:[
    {text:'نشرب القهوة فـ ___',answer:'الكاس',choices:['الكاس','الكرسي','الباب']},
...
// v6.125 : manquait entièrement pour le japonais.
window.ASSESS_ITEMS_JA = {
  denomination:[
    {emoji:'🐶',answer:'犬',choices:['犬','猫','馬']},
    {emoji:'🚲',answer:'自転車',choices:['自転車','バイク','車']},
    {emoji:'🌧️',answer:'雨',choices:['雨','雪','太陽']}
  ],
  completion:[
    {text:'コーヒーを___で飲みます',answer:'カップ',choices:['カップ','椅子','ドア']},
    {text:'夜に___が見えます',answer:'月',choices:['月','テーブル','手']},
    {text:'パンを切るために___を使います',answer:'ナイフ',choices:['ナイフ','本','コップ']}
  ],
  comprehension:[
    {text:'どの動物が飛びますか？',answer:'鳥',choices:['鳥','犬','魚']},
    {text:'本はどこにしまいますか？',answer:'棚の上',choices:['棚の上','冷蔵庫の中','お風呂の中']},
    {text:'はさみは何に使いますか？',answer:'切ること',choices:['切ること','飲むこと','寝ること']}
  ]
};
...
const ASSESS_STRINGS = {
  ...
  kab:{
    ...
    next_btn:'Uḍfir →',
    // v6.152 : 9 clés manquantes comblées (écran de dépôt de bilan
    // externe) — brouillon de ma part, pas relu par une personne
    // kabylophone comme le reste de ce bloc (v6.113/v6.115). Trouvé en
    // marge d'un signalement de mélange de langues en darija.
    imported_from_bilan:'Seg unezgum-ik',
    listen_beginning:'🔊 Ssel i tazwara',
    complete_choices_btn:'Sentem tifrayin-iw sakin kemmel',
    reading_in_progress:'Aɣra iteddu...',
    read_file_failed:'Ur zmireɣ ara ad ɣreɣ afaylu-agi (yezmer ad yili d tugna itwaskanen). Tzemreḍ ad d-tferneḍ s ufus tinuɣtiwin ara teslemdeḍ, ddaw-agi.',
    content_read_label:'Agbur yettwaɣran (ur yettwasekles ara):',
    priority_from_report:'Seg unezgum-agi, d acu i tebɣiḍ ad teslemdeḍ d amezwaru?',
    text_will_be_erased:'Aḍris-agi ad yettwakkes m\'ara tkemmleḍ. Ala tifrayin-ik yettwaɣtsen ara yeqqimen.',
    imported_priorities_detail:(list)=>`Ini-k tebɣiḍ ad teslemdeḍ : ${list}. Ad t-id-awiɣ s tazwara.`,
  },
  // =====================================================================
  //  v6.152 — ASSESS_STRINGS POUR DZ/MA/TN, MANQUAIENT ENTIÈREMENT
  //  ---------------------------------------------------------------------
  //  Signalé par l'utilisateur (captures d'écran : "Bienvenue", "Avez-vous
  //  un bilan ?", "Vos ressentis" en français malgré une interface en
  //  darija) — ces 3 langues n'avaient tout simplement aucune entrée dans
  //  ASSESS_STRINGS, ni de SYMPTOM_QUESTIONS_XX/ASSESS_ITEMS_XX associés,
  //  contrairement au kabyle qui avait déjà un socle partiel. Brouillon de
  //  ma part (pas de fichier natif fourni pour cette partie précise),
  //  même statut que le reste du contenu dz/ma/tn — à faire vérifier par
  //  des locuteurs·rices natif·ves avant tout usage clinique réel.
  // =====================================================================
  dz:{
    welcome:'مرحبا',
    welcome_p1:'قبل ما نبداو، خلينا ناخذو وقت باش نعرفوك مليح. هذا غادي يعاوننا نختارو التمارين الأكثر فائدة بالنسبة ليك.',
    welcome_p2:'كاين شوية خطوات قصيرة. ماكاش جواب صحيح ولا غالط.',
    not_diagnosis:'ℹ️ هذا التيست ماشي تشخيص طبي. يخدم غير باش يخصص التمرين تاعك.',
    start:'ابدا',
    ready:'رانی مستعد',
    small_test:'تيست صغير',
    small_test_p:'شوية أسئلة بسيطة باش نلقاو مع بعض نقاط القوة تاعك وشنو يمكن نخدموا عليه. خذ وقتك.',
    partial_kab_note:'ℹ️ شوية أسئلة من هذا البيلان مازالت بالفرنسية للوقت الحالي.',
    import_title:'عندك بيلان؟',
    import_p1:'إلا عندك تقرير (أورطوفوني، طبي...)، تقدر تحمله. التطبيق غادي يوريه ليك باش يعاونك تلقى النقاط اللي خاصك تخدم عليها، من بعد يمحيه فالوقت.',
    import_note:'🔒 الملف تاعك يبقى فالجهاز تاعك. ما يتبعتش، ما يتسجلش. يتمحى ملي تخرج من هذي الخطوة.',
    import_upload:'📎 دوس باش تختار ملف (PDF ولا نص)',
    skip_step:'تخطى هذي الخطوة ←',
    symptoms_note:'ℹ️ هذوا الأسئلة مازالوا بالفرنسية للوقت الحالي.',
    result_title:'نقطة البداية تاعك',
    result_thanks:'شكرا! هاذي شنو فهمت باش نبداو مليح:',
    priority_label:'نخدمو عليه بالأولوية',
    level_label:'المستوى المنصوح بيه للبداية',
    result_disclaimer:'ℹ️ هذا يخصص التمرين تاعك، ولكن ما يعوضش بيلان أورطوفوني.',
    begin_exercises:'ابدا التمارين تاعي',
    imported_from_bilan:'حسب البيلان تاعك',
    feelings_title:'كيفاش راك حاس',
    listen_btn:'🔊 اسمع',
    listen_question:'🔊 اسمع السؤال',
    listen_beginning:'🔊 اسمع البداية',
    complete_choices_btn:'أكد الاختيارات تاعي وكمل',
    next_btn:'التالي ←',
    reading_in_progress:'قراية جارية...',
    read_file_failed:'ما نجحتش نقرا هذا الملف (يمكن يكون مصور). تقدر تعلم يدويا النقاط اللي خاصك تخدم عليها تحت.',
    content_read_label:'المحتوى المقروء (ماشي محفوظ):',
    priority_from_report:'حسب هذا البيلان، شنو تحب تخدم عليه بالأولوية؟',
    text_will_be_erased:'هذا النص غادي يتمحى ملي تكمل. غير الاختيارات المعلمة تاعك غادي تتحفظ.',
    level_adjust_note:'غادي يتعدل وحدو حسب التقدم تاعك.',
    priority_detail:(rWeak)=>`(${rWeak} فالتيست). غادي نقترح عليك هذا التمرين فالأول.`,
    imported_priorities_detail:(list)=>`قلت تحب تخدم على: ${list}. راني ناخذها بعين الاعتبار بالأولوية.`,
  },
  ma:{
    welcome:'مرحبا',
    welcome_p1:'قبل ما نبداو، خلينا ناخدو وقت باش نعرفوك مزيان. هادشي غادي يعاوننا نختاروا التمارين الأكثر فائدة بالنسبة ليك.',
    welcome_p2:'كاين شوية خطوات قصيرة. ماكاش جواب صحيح ولا غالط.',
    not_diagnosis:'ℹ️ هذا التيست ماشي تشخيص طبي. يخدم غير باش يخصص التمرين تاعك.',
    start:'ابدا',
    ready:'أنا موجود',
    ...
    partial_kab_note:'ℹ️ شوية أسئلة من هذا البيلان مازالت بالفرنسية للوقت الحالي.',
    import_title:'عندك بيلان؟',
    import_p1:'إلا عندك تقرير (أورطوفوني، طبي...)، تقدر تحمّلو. التطبيق غادي يوريه ليك باش يعاونك تلقى النقط اللي خاصك تخدم عليها، من بعد يمحيه فالوقت.',
    import_note:'🔒 الملف ديالك كيبقى فالجهاز ديالك. ماكيتصيفطش، ماكيتسجلش. كيتمحى ملي تخرج من هاد الخطوة.',
    import_upload:'📎 دوس باش تختار ملف (PDF ولا نص)',
    skip_step:'تخطى هذي الخطوة ←',
    symptoms_note:'ℹ️ هذوا الأسئلة مازالوا بالفرنسية للوقت الحالي.',
    result_title:'نقطة البداية ديالك',
    result_thanks:'شكرا! هاذي شنو فهمت باش نبداو مليح:',
    priority_label:'نخدمو عليه بالأولوية',
    level_label:'المستوى المقترح للبداية',
    result_disclaimer:'ℹ️ هذا يخصص التمرين تاعك، ولكن ما يعوضش بيلان أورطوفوني.',
    begin_exercises:'ابدا التمارين تاعي',
    imported_from_bilan:'حسب البيلان ديالك',
    feelings_title:'كيفاش راك حاس',
    listen_btn:'🔊 اسمع',
    listen_question:'🔊 اسمع السؤال',
    listen_beginning:'🔊 اسمع البداية',
    ...
    content_read_label:'المحتوى المقروء (ماشي محفوظ):',
    priority_from_report:'حسب هذا البيلان، شنو تحب تخدم عليه بالأولوية؟',
    text_will_be_erased:'هاد النص غادي يتمحى ملي تكمل. غير الاختيارات المعلمة ديالك غادي تتحفظ.',
    level_adjust_note:'غادي يتعدل بوحدو حسب التقدم ديالك.',
    priority_detail:(rWeak)=>`(${rWeak} فالتيست). غادي نقترح عليك هاد التمرين فالأول.`,
    imported_priorities_detail:(list)=>`قلتي بغيتي تخدم على: ${list}. كنآخدها بعين الاعتبار بالأولوية.`,
  },
  tn:{
    welcome:'مرحبا',
    welcome_p1:'قبل ما نبداو، نحيو وقت باش نعرفوك أحسن. هالشي باش يعاوننا نختاروا التمارين الأكثر فائدة بالنسبة ليك.',
    welcome_p2:'كاين شوية خطوات قصيرة. ماكاش جواب صحيح ولا غالط.',
    not_diagnosis:'ℹ️ هذا التيست ماشي تشخيص طبي. يخدم غير باش يخصص التمرين تاعك.',
    start:'ابدا',
    ready:'أنا مستعد',
    ...
    partial_kab_note:'ℹ️ شوية أسئلة من هذا البيلان مازالت بالفرنسية للوقت الحالي.',
    import_title:'عندك بيلان؟',
    import_p1:'إذا عندك تقرير (أورتوفوني، طبي...)، تنجم تحمّلو. التطبيق باش يعرضهولك باش يعاونك تلقى النقاط اللي لازمك تخدم عليها، وبعد يمحيه فالوقت.',
    import_note:'🔒 الملف متاعك يبقى في جهازك. ما يتبعثش، ما يتسجلش. يتمحى كي تخرج من هالخطوة.',
    import_upload:'📎 دوس باش تختار ملف (PDF ولا نص)',
    skip_step:'تخطى هذي الخطوة ←',
    symptoms_note:'ℹ️ هذوا الأسئلة مازالوا بالفرنسية للوقت الحالي.',
    result_title:'نقطة البداية متاعك',
    result_thanks:'شكرا! هاذي شنو فهمت باش نبداو مليح:',
    priority_label:'نخدمو عليه بالأولوية',
    level_label:'المستوى المنصوح بيه للبداية',
    result_disclaimer:'ℹ️ هذا يخصص التمرين تاعك، ولكن ما يعوضش بيلان أورطوفوني.',
    begin_exercises:'ابدا التمارين تاعي',
    imported_from_bilan:'حسب البيلان متاعك',
    feelings_title:'كيفاش راك حاس',
    listen_btn:'🔊 اسمع',
    listen_question:'🔊 اسمع السؤال',
    listen_beginning:'🔊 اسمع البداية',
    ...
    content_read_label:'المحتوى المقروء (ماشي محفوظ):',
    priority_from_report:'حسب هذا البيلان، شنو تحب تخدم عليه بالأولوية؟',
    text_will_be_erased:'هالنص باش يتمحى كي تكمل. غير الاختيارات المعلمة متاعك باش تتحفظ.',
    level_adjust_note:'باش يتعدل لوحدو حسب التقدم متاعك.',
    priority_detail:(rWeak)=>`(${rWeak} في التيست). باش نقترحلك هالتمرين أول حاجة.`,
    imported_priorities_detail:(list)=>`قلت تحب تخدم على: ${list}. تو ناخدها بعين الاعتبار بالأولوية.`,
  },
  en:{
...
const Assessment = {
  ...
  _intro(){
    this._el().innerHTML=`
      <div class="prompt-card" style="text-align:start">
  ...
  _bilanItem(){
    ...
    if(domain.key==='denomination'){
      ...
      promptHTML=`${ExoImages.html(q.emoji)}<div class="prompt-text">${consigne}</div>`;
    }
  ...
  answerBilan(chosen,answer){
    ...
    if(typeof playFeedbackSound === 'function') playFeedbackSound(ok);
