...
const DAILY_CAP = 40;
const ORTHO_TASKS = ['report_draft', 'suggest_words', 'prep_note', 'rewrite_note', 'generate_exercise', 'evolution_story', 'cabinet_digest', 'research_exercises'];
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (task === 'report_draft' || task === 'prep_note' || task === 'suggest_words' || task === 'generate_exercise' || task === 'evolution_story') {
