...
const AdminPanel = {
  ...
  async renderInactive(){
    ...
    box.innerHTML = rows.map(r =>
      '<div class="history-row" style="display:flex;justify-content:space-between;gap:12px;padding:10px 0">' +
      '<b style="font-family:\'Fredoka\',sans-serif">' + r.label + '</b>' +
      '<span class="hint">' + r.days_inactive + ' j sans séance · ' + r.sessions_count + ' séance(s) au total</span>' +
      '</div>').join('');
  },
