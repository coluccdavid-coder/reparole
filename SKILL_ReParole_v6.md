...
└── tests/ (29 fichiers, 361 tests — voir liste ci-dessous)
    ...
    dashboard-grid, companion-gestures, browser-lang-detect, motor-accessibility, export-restore-data, exercise-help-button, dark-mode-and-profiles, favorite-words, audio-checklist, memory-speed, dark-mode-other-spaces, caregiver-ortho-i18n
```
...
```
Doit afficher **29 suites, toutes ✅, 361 tests**. Sinon, lire le détail
