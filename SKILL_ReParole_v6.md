...
**11 langues** : fr (complète, dénomination 35 mots/niveau) ;
en/es/it/pt/de/ar/tr/pl/**ja** (interface complète + tous les
exercices — ja depuis la v6.91) ; kab et sg (**partielles**,
volontairement — dénomination sourcée uniquement, pas de
synthèse/reconnaissance vocale disponible, mécanisme commun via
`PARTIAL_LANGS`). Voir "Sango", "Kabyle" et "Japonais" ci-dessous pour
l'état précis de chacune.
...
└── tests/ (43 fichiers, 505 tests — voir liste ci-dessous)
...
```
Doit afficher **43 suites, toutes ✅, 505 tests**. Sinon, lire le détail
