...
└── tests/ (23 fichiers, 304 tests — voir liste ci-dessous)
    ...
    dashboard-grid, companion-gestures, browser-lang-detect, motor-accessibility, export-restore-data, exercise-help-button
```
...
```
Doit afficher **23 suites, toutes ✅, 304 tests**. Sinon, lire le détail
