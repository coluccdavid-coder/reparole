...
└── tests/ (26 fichiers, 333 tests — voir liste ci-dessous)
    ...
    dashboard-grid, companion-gestures, browser-lang-detect, motor-accessibility, export-restore-data, exercise-help-button, dark-mode-and-profiles, favorite-words, audio-checklist
```
...
```
Doit afficher **26 suites, toutes ✅, 333 tests**. Sinon, lire le détail
