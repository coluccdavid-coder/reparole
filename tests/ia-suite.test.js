...
(async () => {
  ...
  await test('edge : les 8 tâches existent, réparties par rôle (ortho vs admin), tâche inconnue refusée', () => {
    assert.ok(/ORTHO_TASKS = \['report_draft', 'suggest_words', 'prep_note', 'rewrite_note', 'generate_exercise'\]/.test(DOC));
