...
console.log('Détection de la langue du navigateur (langues partielles, v6.67)');
...
test('navigateur en darija algérienne (dz-DZ) + première visite -> lang détectée = dz', ()=>{
  const dom = loadPatientApp({ languages:['dz-DZ'] });
  assert.strictEqual(dom.window.Prefs.data.lang, 'dz');
});
