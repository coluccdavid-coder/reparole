...
test('Fredoka est réellement chargée (référencée dans dashboard-ortho.html)', ()=>{
  ...
  assert.ok(/family=Fredoka/.test(html), 'Fredoka doit apparaître dans l\'URL Google Fonts chargée');
});
