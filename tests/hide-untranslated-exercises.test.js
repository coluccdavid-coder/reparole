// =====================================================================
//  TESTS — Masquage des exercices sans traduction (v6.146)
//  ---------------------------------------------------------------------
...
//
//  "Rimes" n'est volontairement PAS concerné : une rime ne se
//  traduit dans aucune langue (même anglais/espagnol), ce n'est pas
//  un manque de traduction spécifique à une langue partielle.
//
...
console.log('\n"Rimes" n\'est jamais masqué (limite universelle, pas une traduction manquante)');

await test('"rhyme" reste visible même en langue partielle (limite acceptée pour toutes les langues)', ()=>{
  const dom = loadPatientApp();
