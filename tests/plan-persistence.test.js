    ...
    return {
      rpc(fn, params){
        ...
        if(fn === 'upsert_patient'){
          ...
          rows[params.p_code] = { ...(rows[params.p_code]||{}), code:params.p_code, name:params.p_name, level:params.p_level,
            sessions:params.p_sessions, correct:params.p_correct, total:params.p_total, streak:params.p_streak,
            plan: params.p_plan || (rows[params.p_code]&&rows[params.p_code].plan) || 'free' };
