...
function main(){
  ...
  const dynamicTables = [
    { prefix:'BANK_',                  requiredIn:['en','es','it','pt','de','ar'], shape:'exerciseBank' },
    { prefix:'ASSESS_ITEMS_',          requiredIn:['en','es','it','pt','de','ar'], shape:'assessItems' },
    { prefix:'SYMPTOM_QUESTIONS_',     requiredIn:['en','es','it','pt','de','ar'], shape:'symptomQuestions' },
    { prefix:'ASSESS_DOMAIN_LABELS_',  requiredIn:['en','es','it','pt','de','ar'], shape:'domainLabels' },
    { prefix:'CONV_SCENARIOS_',        requiredIn:['en','es','it','pt','de','ar'], shape:'convScenarios' }
  ];
